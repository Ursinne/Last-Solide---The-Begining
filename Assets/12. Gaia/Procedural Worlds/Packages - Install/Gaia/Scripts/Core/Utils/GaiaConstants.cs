...
namespace Gaia
{
    public static class GaiaConstants
    {
        ...
        public const string gaiaPolyMaskMenuEntry = "GameObject/Procedural Worlds/Gaia/Poly Mask";
        ...
        /// <summary>
        /// Name of the Game Object that holds all design time tools
        /// </summary>
        public static string gaiaToolsObject = "Gaia Tools";

        /// <summary>
        /// Name of the Game Object that holds all polygon masks
        /// </summary>
        public static string gaiaPolyMaskObject = "PolyMasks";
        ...
        /// <summary>
        /// Global multiplier for HDRP sun intensity
        /// </summary>
        public static readonly float HDRPSunIntensityMultiplier = 2.14f;
    }
}
